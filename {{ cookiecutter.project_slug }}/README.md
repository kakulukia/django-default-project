...
Install [uv](https://docs.astral.sh/uv/getting-started/installation/) and Sass
(`npm install -g sass`, with Node.js installed). Python 3.14 is the project default;
uv can install the required Python version automatically.
