...
const Ve=2.4,we=.2126729,Se=.7151522,ke=.072175,xe=.55,Ne=.58,Ce=.57,_e=.62,Ie=.03,Pe=1.45,Be=5e-4,Ae=1.25,Re=1.25,Te=.078,De=12.82051282051282,Ee=.06,Fe=.001
...
if(u<=Ie&&(u+=(Ie-u)**Pe),c<=Ie&&(c+=(Ie-c)**Pe),Math.abs(c-u)<Be)return 0
if(c>u){const e=(c**xe-u**Ne)*Ae
s=e<Fe?0:e<Te?e-e*De*Ee:e-Ee}else{const e=(c**_e-u**Ce)*Re
s=e>-Fe?0:e>-Te?e-e*De*Ee:e+Ee}return 100*s}function Me(e){t.warn(`Vuetify: ${e}`)}function Oe(e){t.warn(`Vuetify error: ${e}`)}const Le=.20689655172413793,ze=e=>e>Le**3?Math.cbrt(e):e/(3*Le**2)+4/29,je=e=>e>Le?e**3:3*Le**2*(e-4/29)
...
if("string"==typeof e&&Qe.test(e)){const{groups:t}=e.match(Qe),{fn:a,values:l}=t,o=l.split(/,\s*/).map((e=>e.endsWith("%")&&["hsl","hsla","hsv","hsva"].includes(a)?parseFloat(e)/100:parseFloat(e)))
...
return(isNaN(a)||a<0||a>4294967295)&&Me(`'${e}' is not a valid hex(a) color`),ct(t)}if("object"==typeof e){if(w(e,["r","g","b"]))return e
if(w(e,["h","s","l"]))return tt(nt(e))
if(w(e,["h","s","v"]))return tt(e)}throw new TypeError(`Invalid color: ${null==e?e:String(e)||e.constructor.name}\nExpected #hex, #hexa, rgb(), rgba(), hsl(), hsla(), object or number`)}function tt(e){const{h:t,s:a,v:l,a:o}=e,n=e=>{const o=(e+t/60)%6
...
t.provide(xt,t.computed((()=>i.value?$(e?.value??{},i.value):e?.value)))}}}function It(e){if(e._setup=e._setup??e.setup,!e.name)return Me("The component is missing an explicit name, unable to generate default prop value"),e
...
let c=d(s,i,null)
return c||(Me(`Translation key "${l}" not found in "${e.value}", trying fallback locale`),c=d(u,i,null)),c||(Oe(`Translation key "${l}" not found in fallback`),c=l),"string"!=typeof c&&(Oe(`Translation key "${l}" has a non-string value`),c=l),da(c,n)}
...
for(const r of p(l.variations[a],1))o.colors[`${e}-${a}-${r}`]=ut(n(et(t),r))}}for(const e of Object.keys(o.colors)){if(/^on-[a-z]/.test(e)||o.colors[`on-${e}`])continue
const t=`on-${e}`,a=et(o.colors[e])
...
const{x:l,y:o,sx:n,sy:r,speed:i}=La(e.target,t),s=ye(t,[{transform:`translate(${l}px, ${o}px) scale(${n}, ${r})`,opacity:0},{}],{duration:225*i,easing:"cubic-bezier(0.0, 0, 0.2, 1)"})
Oa(t)?.forEach((e=>{ye(e,[{opacity:0},{opacity:0,offset:.33},{}],{duration:450*i,easing:Rt})})),s.finished.then((()=>a()))},onAfterEnter(e){e.style.removeProperty("pointer-events")},onBeforeLeave(e){e.style.pointerEvents="none"},async onLeave(t,a){await new Promise((e=>requestAnimationFrame(e)))
const{x:l,y:o,sx:n,sy:r,speed:i}=La(e.target,t)
ye(t,[{},{transform:`translate(${l}px, ${o}px) scale(${n}, ${r})`,opacity:0}],{duration:125*i,easing:"cubic-bezier(0.4, 0, 1, 1)"}).finished.then((()=>a())),Oa(t)?.forEach((e=>{ye(e,[{},{opacity:0,offset:.2},{opacity:0}],{duration:250*i,easing:Rt})}))},onAfterLeave(e){e.style.removeProperty("pointer-events")}}
return()=>e.target?t.createVNode(t.Transition,t.mergeProps({name:"dialog-transition"},o,{css:!1}),l):t.createVNode(t.Transition,{name:"dialog-transition"},l)}})
function Oa(e){const t=e.querySelector(":scope > .v-card, :scope > .v-sheet, :scope > .v-list")?.children
return t&&[...t]}function La(e,t){const a=ge(e),l=he(t),[o,n]=getComputedStyle(t).transformOrigin.split(" ").map((e=>parseFloat(e))),[r,i]=getComputedStyle(t).getPropertyValue("--v-overlay-anchor-origin").split(" ")
...
if(e.value.background)if(Ze(e.value.background)){if(a.backgroundColor=e.value.background,!e.value.text&&(Ze(l=e.value.background)&&!/^((rgb|hsl)a?\()?var\(--/.test(l))){const t=et(e.value.background)
if(null==t.a||1===t.a){const e=gt(t)
a.color=e,a.caretColor=e}}}else t.push(`bg-${e.value.background}`)
var l
return e.value.text&&(Ze(e.value.text)?(a.color=e.value.text,a.caretColor=e.value.text):t.push(`text-${e.value.text}`)),{colorClasses:t,colorStyles:a}}))}function ul(e,a){const l=t.computed((()=>({text:t.isRef(e)?e.value:a?e[a]:null}))),{colorClasses:o,colorStyles:n}=sl(l)
...
t?t!==r.value&&(r.value?.removeEventListener("scroll",f),r.value=t,r.value.addEventListener("scroll",f,{passive:!0})):Me(`Unable to locate element with identifier ${e}`)}),{immediate:!0})})),t.onBeforeUnmount((()=>{r.value?.removeEventListener("scroll",f)})),l&&t.watch(l,f,{immediate:!0}),{scrollThreshold:v,currentScroll:i,currentThreshold:u,isScrollActive:c,scrollRatio:p,isScrollingUp:d,savedScroll:s}}(e,{canScroll:i}),v=t.computed((()=>r.value.hide||r.value.fullyHide)),p=t.computed((()=>e.collapse||r.value.collapse&&(r.value.inverted?d.value>0:0===d.value))),f=t.computed((()=>e.flat||r.value.fullyHide&&!n.value||r.value.elevate&&(r.value.inverted?s.value>0:0===s.value))),m=t.computed((()=>r.value.fadeImage?r.value.inverted?1-d.value:d.value:void 0)),g=t.computed((()=>{if(r.value.hide&&r.value.inverted)return 0
...
let o=l
if("string"==typeof o&&(o=o.trim(),o.startsWith("$")&&(o=a.aliases?.[o.slice(1)])),o||Me(`Could not find aliased icon "${l}"`),Array.isArray(o))return{component:Ht,icon:o}
...
return t.createVNode(Zl,{icon:e[`${o}Icon`],"aria-label":i,onClick:r,onKeydown:function(e){"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),e.stopPropagation(),K(r,new PointerEvent("click",e)))}},null)}}}const ln=ht({active:Boolean,color:String,messages:{type:[Array,String],default:()=>[]},...yt(),...pl({transition:{component:Qa,leaveAbsolute:!0,group:!0}})},"VMessages"),on=Pt()({name:"VMessages",props:ln(),setup(e,a){let{slots:l}=a
const o=t.computed((()=>A(e.messages))),{textColorClasses:n,textColorStyles:r}=ul(t.computed((()=>e.color)))
return Mt((()=>t.createVNode(fl,{transition:e.transition,tag:"div",class:["v-messages",n.value,e.class],style:[r.value,e.style]},{default:()=>[e.active&&o.value.map(((e,a)=>t.createVNode("div",{class:"v-messages__message",key:`${a}-${o.value}`},[l.message?l.message({message:e}):e])))]}))),{}}}),nn=ht({focused:Boolean,"onUpdate:focused":G()},"focus")
...
function cn(e){const a=t.inject(sn,null)
return{...a,isReadonly:t.computed((()=>!!(e?.readonly??a?.isReadonly.value))),isDisabled:t.computed((()=>!!(e?.disabled??a?.isDisabled.value)))}}const dn=ht({disabled:{type:Boolean,default:null},error:Boolean,errorMessages:{type:[Array,String],default:()=>[]},maxErrors:{type:[Number,String],default:1},name:String,label:String,readonly:{type:Boolean,default:null},rules:{type:Array,default:()=>[]},modelValue:null,validateOn:String,validationValue:null,...nn()},"validation")
...
const o=sa(e,"modelValue"),n=t.computed((()=>void 0===e.validationValue?o.value:e.validationValue)),r=cn(e),i=t.ref([]),s=t.shallowRef(!0),u=t.computed((()=>!(!A(""===o.value?null:o.value).length&&!A(""===n.value?null:n.value).length))),c=t.computed((()=>e.errorMessages?.length?A(e.errorMessages).concat(i.value).slice(0,Math.max(0,+e.maxErrors)):i.value)),d=t.computed((()=>{let t=(e.validateOn??r.validateOn?.value)||"input"
...
!0!==o&&(!1===o||"string"==typeof o?a.push(o||""):console.warn(`${o} is not a valid value. Rule functions must return boolean true or a string.`))}return i.value=a,p.value=!1,s.value=t,i.value}return t.onBeforeMount((()=>{r.register?.({id:g.value,vm:m,validate:b,reset:h,resetValidation:y})})),t.onBeforeUnmount((()=>{r.unregister?.(g.value)})),t.onMounted((async()=>{d.value.lazy||await b(!d.value.eager),r.update?.(g.value,v.value,c.value)})),ia((()=>d.value.input||d.value.invalidInput&&!1===v.value),(()=>{t.watch(n,(()=>{if(null!=n.value)b()
else if(e.focused){const a=t.watch((()=>e.focused),(e=>{e||b(),a()}))}}))})),ia((()=>d.value.blur),(()=>{t.watch((()=>e.focused),(e=>{e||b()}))})),t.watch([v,c],(()=>{r.update?.(g.value,v.value,c.value)})),{errorMessages:c,isDirty:u,isDisabled:r.isDisabled,isReadonly:r.isReadonly,isPristine:s,isValid:v,isValidating:p,reset:h,resetValidation:y,validate:b,validationClasses:f}}const pn=ht({id:String,appendIcon:Ot,centerAffix:{type:Boolean,default:!0},prependIcon:Ot,hideDetails:[Boolean,String],hideSpinButtons:Boolean,hint:String,persistentHint:Boolean,messages:{type:[Array,String],default:()=>[]},direction:{type:String,default:"horizontal",validator:e=>["horizontal","vertical"].includes(e)},"onClick:prepend":G(),"onClick:append":G(),...yt(),...Al(),...N(ol(),["maxWidth","minWidth","width"]),...Sa(),...dn()},"VInput"),fn=Pt()({name:"VInput",props:{...pn()},emits:{"update:modelValue":e=>!0},setup(e,a){let{attrs:l,slots:o,emit:n}=a
...
function Nn(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{mobile:null},a=arguments.length>1&&void 0!==arguments[1]?arguments[1]:Vt()
const l=t.inject(yn)
...
return s[o]=r,l>=1&&Math.abs(r-s[o])<10?e(c):l>2?(Me("Scroll target is not reachable"),e(s[o])):void requestAnimationFrame(t)}))))}function Bn(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
...
const{themeClasses:I}=xa(e),{borderClasses:P}=Vl(e),{colorClasses:B,colorStyles:A,variantClasses:R}=Fl(C),{densityClasses:T}=Rl(e),{dimensionStyles:D}=nl(e),{elevationClasses:E}=Sl(e),{roundedClasses:F}=vl(x),$=t.computed((()=>e.lines?`v-list-item--${e.lines}-line`:void 0)),M=t.computed((()=>({isActive:V.value,select:c,isOpen:d.value,isSelected:v.value,isIndeterminate:p.value})))
function O(t){n("click",t),k.value&&(r.navigate?.(t),f||(m.activatable.value?s(!u.value,t):(m.selectable.value||null!=e.value)&&c(!v.value,t)))}function L(e){"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),e.target.dispatchEvent(new MouseEvent("click",e)))}return Mt((()=>{const a=w.value?"a":e.tag,l=o.title||null!=e.title,n=o.subtitle||null!=e.subtitle,i=!(!e.appendAvatar&&!e.appendIcon),s=!(!i&&!o.append),c=!(!e.prependAvatar&&!e.prependIcon),d=!(!c&&!o.prepend)
var p,f
...
if(!f&&t)h.push(...t)
else{for(const t of f?u:d)if(m(e,t.value)){h.push(t)
continue e}h.push(br(g,e))}}return h},transformOut:function(t){return e.returnObject?t.map((e=>{let{raw:t}=e
return t})):t.map((e=>{let{value:t}=e
return t}))}}}function Sr(e,t){const a=v(t,e.itemType,"item"),l=ne(t)?t:v(t,e.itemTitle),o=v(t,e.itemValue,void 0),n=v(t,e.itemChildren),r={title:l,value:o,...!0===e.itemProps?x(t,["children"]):v(t,e.itemProps)}
...
const t=ge(e.target.value),a=function(e,t){const a=he(e)
...
const p=v.reduce(((e,t)=>{const a=t.getBoundingClientRect(),l=new fe({x:t===document.documentElement?0:a.x,y:t===document.documentElement?0:a.y,width:t.clientWidth,height:t.clientHeight})
...
function g(e){const l=new fe(a),o=Rr(e.anchor,t),n=Rr(e.origin,l)
...
return{overflows:me(l,p),x:r,y:i}}let h=0,y=0
const b={x:0,y:0},V={x:!1,y:!1}
let w=-1
for(;;){if(w++>10){Oe("Infinite loop detected in connectedLocationStrategy")
break}const{x:e,y:t,overflows:l}=g(m)
h+=e,y+=t,a.x+=e,a.y+=t
{const e=pe(m.anchor),t=l.x.before||l.x.after,a=l.y.before||l.y.after
let o=!1
if(["x","y"].forEach((n=>{if("x"===n&&t&&!V.x||"y"===n&&a&&!V.y){const t={anchor:{...m.anchor},origin:{...m.origin}},a="x"===n?"y"===e?de:ce:"y"===e?ce:de
...
{const e=me(a,p)
b.x=p.width-e.x.before-e.x.after,b.y=p.height-e.y.before-e.y.after,h+=e.x.before,a.x+=e.x.before,y+=e.y.before,a.y+=e.y.before}break}const S=pe(m.anchor)
...
a&&function(e,t){Object.keys(t).forEach((a=>{if(_(a)){const l=Y(a),o=be.get(e)
...
a&&function(e,t){Object.keys(t).forEach((t=>{if(_(t)){const a=Y(t),l=be.get(e)
...
function i(e){e.state?.replaced||(r=!0,setTimeout((()=>r=!1)))}a&&e?.beforeEach&&(t.nextTick((()=>{window.addEventListener("popstate",i),o=e.beforeEach(((e,t,a)=>{go?r?l(a):a():setTimeout((()=>r?l(a):a())),go=!0})),n=e?.afterEach((()=>{go=!1}))})),t.onScopeDispose((()=>{window.removeEventListener("popstate",i),o?.(),n?.()})))}(L,(t=>{V.value&&v.value?(t(!1),e.persistent?j():v.value=!1):t()}))}))
const z=t.ref()
function j(){e.noClickAnimation||c.value&&ye(c.value,[{transformOrigin:"center"},{transform:"scale(1.03)"},{transformOrigin:"center"}],{duration:150,easing:Rt})}function H(){r("afterEnter")}function W(){y(),r("afterLeave")}return t.watch((()=>v.value&&(e.absolute||e.contained)&&null==A.value),(e=>{if(e){const e=Dt(s.value)
...
const{themeClasses:r}=xa(e),{loaderClasses:i}=io(e),{focusClasses:s,isFocused:u,focus:c,blur:d}=rn(e),{InputIcon:v}=an(e),{roundedClasses:p}=vl(e),{rtlClasses:m}=Va(),g=t.computed((()=>e.dirty||e.active)),h=t.computed((()=>!(!e.label&&!n.label))),y=t.computed((()=>!e.singleLine&&h.value)),b=kt(),V=t.computed((()=>e.id||`input-${b}`)),w=t.computed((()=>`${V.value}-messages`)),S=t.ref(),k=t.ref(),x=t.ref(),N=t.computed((()=>["plain","underlined"].includes(e.variant))),{backgroundColorClasses:C,backgroundColorStyles:_}=cl(t.toRef(e,"bgColor")),{textColorClasses:I,textColorStyles:P}=ul(t.computed((()=>e.error||e.disabled?void 0:g.value&&u.value?e.color:e.baseColor)))
...
t.style.visibility="visible",a.style.visibility="hidden",ye(t,{transform:`translate(${n}px, ${r}px) scale(${v})`,color:p,...s},{duration:d,easing:Rt,direction:e?"normal":"reverse"}).finished.then((()=>{t.style.removeProperty("visibility"),a.style.removeProperty("visibility")}))}))}}),{flush:"post"})
const B=t.computed((()=>({isActive:g,isFocused:u,controlRef:x,blur:d,focus:c})))
function A(e){e.target!==document.activeElement&&e.preventDefault()}return Mt((()=>{const a="outlined"===e.variant,o=!(!n["prepend-inner"]&&!e.prependInnerIcon),u=!(!e.clearable&&!n.clear||e.disabled),f=!!(n["append-inner"]||e.appendInnerIcon||u),b=()=>n.label?n.label({...B.value,label:e.label,props:{for:V.value}}):e.label
return t.createVNode("div",t.mergeProps({class:["v-field",{"v-field--active":g.value,"v-field--appended":f,"v-field--center-affix":e.centerAffix??!N.value,"v-field--disabled":e.disabled,"v-field--dirty":e.dirty,"v-field--error":e.error,"v-field--flat":e.flat,"v-field--has-background":!!e.bgColor,"v-field--persistent-clear":e.persistentClear,"v-field--prepended":o,"v-field--reverse":e.reverse,"v-field--single-line":e.singleLine,"v-field--no-label":!b(),[`v-field--variant-${e.variant}`]:!0},r.value,C.value,s.value,i.value,p.value,m.value,e.class],style:[_.value,e.style],onClick:A},l),[t.createVNode("div",{class:"v-field__overlay"},null),t.createVNode(so,{name:"v-field",active:!!e.loading,color:e.error?"error":"string"==typeof e.loading?e.loading:e.color},{default:n.loader}),o&&t.createVNode("div",{key:"prepend",class:"v-field__prepend-inner"},[e.prependInnerIcon&&t.createVNode(v,{key:"prepend-icon",name:"prependInner"},null),n["prepend-inner"]?.(B.value)]),t.createVNode("div",{class:"v-field__field","data-no-activator":""},[["filled","solo","solo-inverted","solo-filled"].includes(e.variant)&&y.value&&t.createVNode(yi,{key:"floating-label",ref:k,class:[I.value],floating:!0,for:V.value,style:P.value},{default:()=>[b()]}),h.value&&t.createVNode(yi,{key:"label",ref:S,for:V.value},{default:()=>[b()]}),n.default?.({...B.value,props:{id:V.value,class:"v-field__input","aria-describedby":w.value},focus:c,blur:d})]),u&&t.createVNode(tl,{key:"clear"},{default:()=>[t.withDirectives(t.createVNode("div",{class:"v-field__clearable",onMousedown:e=>{e.preventDefault(),e.stopPropagation()}},[t.createVNode(ll,{defaults:{VIcon:{icon:e.clearIcon}}},{default:()=>[n.clear?n.clear({...B.value,props:{onFocus:c,onBlur:d,onClick:e["onClick:clear"]}}):t.createVNode(v,{name:"clear",onFocus:c,onBlur:d},null)]})]),[[t.vShow,e.dirty]])]}),f&&t.createVNode("div",{key:"append",class:"v-field__append-inner"},[n["append-inner"]?.(B.value),e.appendInnerIcon&&t.createVNode(v,{key:"append-icon",name:"appendInner"},null)]),t.createVNode("div",{class:["v-field__outline",I.value],style:P.value},[a&&t.createVNode(t.Fragment,null,[t.createVNode("div",{class:"v-field__outline__start"},null),y.value&&t.createVNode("div",{class:"v-field__outline__notch"},[t.createVNode(yi,{ref:k,floating:!0,for:V.value},{default:()=>[b()]})]),t.createVNode("div",{class:"v-field__outline__end"},null)]),N.value&&y.value&&t.createVNode(yi,{ref:k,floating:!0,for:V.value},{default:()=>[b()]})])])})),{controlRef:x}}})
...
let B=-1
function A(){c.value&&d.value&&(I=0,P=0,window.clearTimeout(B),D())}let T=-1
...
t-P>500?(I=Math.sign(e-_),v=d.value.offsetTop):I=e-_,_=e,P=t,window.clearTimeout(B),B=window.setTimeout(A,500),D()},handleScrollend:A,handleItemResize:function(e,t){const a=y[e],l=n.value
n.value=l?Math.min(n.value,t):t,a===t&&l===n.value||(y[e]=t,k())}}}const Bi=ht({items:{type:Array,default:()=>[]},renderless:Boolean,...Ii(),...yt(),...ol()},"VVirtualScroll"),Ai=Pt()({name:"VVirtualScroll",props:Bi(),setup(e,a){let{slots:l}=a
...
i.value===document.documentElement?(document[e]("scroll",u,{passive:!0}),document[e]("scrollend",c)):(i.value?.[e]("scroll",u,{passive:!0}),i.value?.[e]("scrollend",c))}t.onMounted((()=>{i.value=Dt(o.vnode.el,!0),e(!0)})),t.onScopeDispose(e)})),Mt((()=>{const a=g.value.map((a=>t.createVNode(_i,{key:a.key,renderless:e.renderless,"onUpdate:height":e=>d(a.index,e)},{default:e=>l.default?.({item:a.raw,index:a.index,...e})})))
...
const{t:n}=ya(),r=t.ref(),i=t.ref(),s=t.ref(),u=sa(e,"menu"),d=t.computed({get:()=>u.value,set:e=>{u.value&&!e&&i.value?.ΨopenChildren.size||(u.value=e)}}),{items:v,transformIn:p,transformOut:f}=wr(e),m=sa(e,"modelValue",[],(e=>p(null===e?[null]:A(e))),(t=>{const a=f(t)
return e.multiple?a:a[0]??null})),g=t.computed((()=>"function"==typeof e.counterValue?e.counterValue(m.value):"number"==typeof e.counterValue?e.counterValue:m.value.length)),h=cn(e),y=t.computed((()=>m.value.map((e=>e.value)))),b=t.shallowRef(!1),V=t.computed((()=>d.value?e.closeText:e.openText))
let w,S=""
const k=t.computed((()=>e.hideSelected?v.value.filter((t=>!m.value.some((a=>(e.valueComparator||c)(a,t))))):v.value)),x=t.computed((()=>e.hideNoData&&!k.value.length||h.isReadonly.value||h.isDisabled.value)),N=t.computed((()=>({...e.menuProps,activatorProps:{...e.menuProps?.activatorProps||{},"aria-haspopup":"listbox"}}))),C=t.ref(),_=Ri(C,r)
function I(t){e.openOnClear&&(d.value=!0)}function P(){x.value||(d.value=!d.value)}function B(e){oe(e)&&R(e)}function R(e){if(!e.key||h.isReadonly.value)return;["Enter"," ","ArrowDown","ArrowUp","Home","End"].includes(e.key)&&e.preventDefault(),["Enter","ArrowDown"," "].includes(e.key)&&(d.value=!0),["Escape","Tab"].includes(e.key)&&(d.value=!1),"Home"===e.key?C.value?.focus("first"):"End"===e.key&&C.value?.focus("last")
if(!oe(e))return
const t=performance.now()
t-w>1e3&&(S=""),S+=e.key.toLowerCase(),w=t
const l=v.value.find((e=>e.title.toLowerCase().startsWith(S)))
if(void 0!==l){m.value=[l]
...
if(!a.props.disabled)if(e.multiple){const t=m.value.findIndex((t=>(e.valueComparator||c)(t.value,a.value))),o=null==l?!~t:l
if(~t){const e=o?[...m.value,a]:[...m.value]
e.splice(t,1),m.value=e}else o&&(m.value=[...m.value,a])}else{const e=!1!==l
m.value=e?[a]:[],t.nextTick((()=>{d.value=!1}))}}function D(e){C.value?.$el.contains(e.relatedTarget)||(d.value=!1)}function E(){e.eager&&s.value?.calculateVisibleItems()}function F(){b.value&&r.value?.focus()}function $(e){b.value=!0}function M(e){if(null==e)m.value=[]
else if(te(r.value,":autofill")||te(r.value,":-webkit-autofill")){const t=v.value.find((t=>t.title===e))
t&&T(t)}else r.value&&(r.value.value="")}return t.watch(d,(()=>{if(!e.hideSelected&&d.value&&m.value.length){const t=k.value.findIndex((t=>m.value.some((a=>(e.valueComparator||c)(a.value,t.value)))))
a&&window.requestAnimationFrame((()=>{t>=0&&s.value?.scrollToIndex(t)}))}})),t.watch((()=>e.items),((e,t)=>{d.value||b.value&&!t.length&&e.length&&(d.value=!0)})),Mt((()=>{const a=!(!e.chips&&!o.chip),l=!!(!e.hideNoData||k.value.length||o["prepend-item"]||o["append-item"]||o["no-data"]),u=m.value.length>0,c=Ni.filterProps(e),v=u||!b.value&&e.label&&!e.persistentPlaceholder?void 0:e.placeholder
return t.createVNode(Ni,t.mergeProps({ref:r},c,{modelValue:m.value.map((e=>e.props.value)).join(", "),"onUpdate:modelValue":M,focused:b.value,"onUpdate:focused":e=>b.value=e,validationValue:m.externalValue,counterValue:g.value,dirty:u,class:["v-select",{"v-select--active-menu":d.value,"v-select--chips":!!e.chips,["v-select--"+(e.multiple?"multiple":"single")]:!0,"v-select--selected":m.value.length,"v-select--selection-slot":!!o.selection},e.class],style:e.style,inputmode:"none",placeholder:v,"onClick:clear":I,"onMousedown:control":P,onBlur:D,onKeydown:R,"aria-label":n(V.value),title:n(V.value)}),{...o,default:()=>t.createVNode(t.Fragment,null,[t.createVNode(fi,t.mergeProps({ref:i,modelValue:d.value,"onUpdate:modelValue":e=>d.value=e,activator:"parent",contentClass:"v-select__content",disabled:x.value,eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,transition:e.transition,onAfterEnter:E,onAfterLeave:F},N.value),{default:()=>[l&&t.createVNode(Nr,t.mergeProps({ref:C,selected:y.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault(),onKeydown:B,onFocusin:$,tabindex:"-1","aria-live":"polite",color:e.itemColor??e.color},_,e.listProps),{default:()=>[o["prepend-item"]?.(),!k.value.length&&!e.hideNoData&&(o["no-data"]?.()??t.createVNode(dr,{key:"no-data",title:n(e.noDataText)},null)),t.createVNode(Ai,{ref:s,renderless:!0,items:k.value},{default:a=>{let{item:l,index:n,itemRef:r}=a
...
return t.createVNode(t.Fragment,null,[e.multiple&&!e.hideSelected?t.createVNode(tn,{key:l.value,modelValue:o,ripple:!1,tabindex:"-1"},null):void 0,l.props.prependAvatar&&t.createVNode(Uo,{image:l.props.prependAvatar},null),l.props.prependIcon&&t.createVNode(Zl,{icon:l.props.prependIcon},null)])}})}}),o["append-item"]?.()]})]}),m.value.map(((l,n)=>{function r(e){e.stopPropagation(),e.preventDefault(),T(l,!1)}const i={"onClick:close":r,onKeydown(e){"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),e.stopPropagation(),r(e))},onMousedown(e){e.preventDefault(),e.stopPropagation()},modelValue:!0,"onUpdate:modelValue":void 0},s=a?!!o.chip:!!o.selection,u=s?ae(a?o.chip({item:l,index:n,props:i}):o.selection({item:l,index:n})):void 0
if(!s||u)return t.createVNode("div",{key:l.value,class:"v-select__selection"},[a?o.chip?t.createVNode(ll,{key:"chip-defaults",defaults:{VChip:{closable:e.closableChips,size:"small",text:l.title}}},{default:()=>[u]}):t.createVNode(jn,t.mergeProps({key:"chip",closable:e.closableChips,size:"small",text:l.title,disabled:l.props.disabled},i),null):u??t.createVNode("span",{class:"v-select__selection-text"},[l.title,e.multiple&&n<m.value.length-1&&t.createVNode("span",{class:"v-select__selection-comma"},[t.createTextVNode(",")])])])}))]),"append-inner":function(){for(var a=arguments.length,l=new Array(a),n=0;n<a;n++)l[n]=arguments[n]
return t.createVNode(t.Fragment,null,[o["append-inner"]?.(...l),e.menuIcon?t.createVNode(Zl,{class:"v-select__menu-icon",icon:e.menuIcon},null):void 0])}})})),vi({isFocused:b,menu:d,select:T},r)}}),Fi=(e,t,a)=>null==e||null==t?-1:e.toString().toLocaleLowerCase().indexOf(t.toString().toLocaleLowerCase()),$i=ht({customFilter:Function,customKeyFilter:Object,filterKeys:[Array,String],filterMode:{type:String,default:"intersection"},noFilter:Boolean},"filter")
...
const{t:n}=ya(),r=t.ref(),i=t.shallowRef(!1),s=t.shallowRef(!0),u=t.shallowRef(!1),d=t.ref(),v=t.ref(),p=sa(e,"menu"),f=t.computed({get:()=>p.value,set:e=>{p.value&&!e&&d.value?.ΨopenChildren.size||(p.value=e)}}),m=t.shallowRef(-1),g=t.computed((()=>r.value?.color)),h=t.computed((()=>f.value?e.closeText:e.openText)),{items:y,transformIn:b,transformOut:V}=wr(e),{textColorClasses:w,textColorStyles:S}=ul(g),k=sa(e,"search",""),x=sa(e,"modelValue",[],(e=>b(null===e?[null]:A(e))),(t=>{const a=V(t)
return e.multiple?a:a[0]??null})),N=t.computed((()=>"function"==typeof e.counterValue?e.counterValue(x.value):"number"==typeof e.counterValue?e.counterValue:x.value.length)),C=cn(e),{filteredItems:_,getMatches:I}=Mi(e,y,(()=>s.value?"":k.value)),P=t.computed((()=>e.hideSelected?_.value.filter((e=>!x.value.some((t=>t.value===e.value)))):_.value)),B=t.computed((()=>!(!e.chips&&!o.chip))),R=t.computed((()=>B.value||!!o.selection)),T=t.computed((()=>x.value.map((e=>e.props.value)))),D=t.computed((()=>(!0===e.autoSelectFirst||"exact"===e.autoSelectFirst&&k.value===P.value[0]?.title)&&P.value.length>0&&!s.value&&!u.value)),E=t.computed((()=>e.hideNoData&&!P.value.length||C.isReadonly.value||C.isDisabled.value)),F=t.ref(),$=Ri(F,r)
function M(t){e.openOnClear&&(f.value=!0),k.value=""}function O(){E.value||(f.value=!0)}function L(e){E.value||(i.value&&(e.preventDefault(),e.stopPropagation()),f.value=!f.value)}function z(e){" "!==e.key&&oe(e)&&r.value?.focus()}function j(t){if(C.isReadonly.value)return
const a=r.value.selectionStart,l=x.value.length
if(["Enter","ArrowDown","ArrowUp"].includes(t.key)&&t.preventDefault(),["Enter","ArrowDown"].includes(t.key)&&(f.value=!0),["Escape"].includes(t.key)&&(f.value=!1),D.value&&["Enter","Tab"].includes(t.key)&&!x.value.some((e=>{let{value:t}=e
return t===P.value[0].value}))&&X(P.value[0]),"ArrowDown"===t.key&&D.value&&F.value?.focus("next"),["Backspace","Delete"].includes(t.key)){if(!e.multiple&&R.value&&x.value.length>0&&!k.value)return X(x.value[0],!1)
if(~m.value){t.preventDefault()
const e=m.value
X(x.value[m.value],!1),m.value=e>=l-1?l-2:e}else"Backspace"!==t.key||k.value||(m.value=l-1)}else if(e.multiple)if("ArrowLeft"===t.key){if(m.value<0&&a>0)return
const e=m.value>-1?m.value-1:l-1
x.value[e]?m.value=e:(m.value=-1,r.value.setSelectionRange(k.value?.length,k.value?.length))}else if("ArrowRight"===t.key){if(m.value<0)return
const e=m.value+1
x.value[e]?m.value=e:(m.value=-1,r.value.setSelectionRange(0,0))}else~m.value&&oe(t)&&(m.value=-1)}function H(e){if(te(r.value,":autofill")||te(r.value,":-webkit-autofill")){const t=y.value.find((t=>t.title===e.target.value))
t&&X(t)}}function W(){e.eager&&v.value?.calculateVisibleItems()}function U(){i.value&&(s.value=!0,r.value?.focus())}function Y(e){i.value=!0,setTimeout((()=>{u.value=!0}))}function G(e){u.value=!1}function q(t){null!=t&&(""!==t||e.multiple||R.value)||(x.value=[])}const K=t.shallowRef(!1)
function X(a){let l=!(arguments.length>1&&void 0!==arguments[1])||arguments[1]
if(a&&!a.props.disabled)if(e.multiple){const t=x.value.findIndex((t=>(e.valueComparator||c)(t.value,a.value))),o=null==l?!~t:l
if(~t){const e=o?[...x.value,a]:[...x.value]
e.splice(t,1),x.value=e}else o&&(x.value=[...x.value,a])
e.clearOnSelect&&(k.value="")}else{const e=!1!==l
x.value=e?[a]:[],k.value=e&&!R.value?a.title:"",t.nextTick((()=>{f.value=!1,s.value=!0}))}}return t.watch(i,((a,l)=>{a!==l&&(a?(K.value=!0,k.value=e.multiple||R.value?"":String(x.value.at(-1)?.props.title??""),s.value=!0,t.nextTick((()=>K.value=!1))):(e.multiple||null!=k.value||(x.value=[]),f.value=!1,x.value.some((e=>{let{title:t}=e
return t===k.value}))||(k.value=""),m.value=-1))})),t.watch(k,(e=>{i.value&&!K.value&&(e&&(f.value=!0),s.value=!e)})),t.watch(f,(()=>{if(!e.hideSelected&&f.value&&x.value.length){const e=P.value.findIndex((e=>x.value.some((t=>e.value===t.value))))
a&&window.requestAnimationFrame((()=>{e>=0&&v.value?.scrollToIndex(e)}))}})),t.watch((()=>e.items),((e,t)=>{f.value||i.value&&!t.length&&e.length&&(f.value=!0)})),Mt((()=>{const a=!!(!e.hideNoData||P.value.length||o["prepend-item"]||o["append-item"]||o["no-data"]),l=x.value.length>0,u=Ni.filterProps(e)
return t.createVNode(Ni,t.mergeProps({ref:r},u,{modelValue:k.value,"onUpdate:modelValue":[e=>k.value=e,q],focused:i.value,"onUpdate:focused":e=>i.value=e,validationValue:x.externalValue,counterValue:N.value,dirty:l,onChange:H,class:["v-autocomplete","v-autocomplete--"+(e.multiple?"multiple":"single"),{"v-autocomplete--active-menu":f.value,"v-autocomplete--chips":!!e.chips,"v-autocomplete--selection-slot":!!R.value,"v-autocomplete--selecting-index":m.value>-1},e.class],style:e.style,readonly:C.isReadonly.value,placeholder:l?void 0:e.placeholder,"onClick:clear":M,"onMousedown:control":O,onKeydown:j}),{...o,default:()=>t.createVNode(t.Fragment,null,[t.createVNode(fi,t.mergeProps({ref:d,modelValue:f.value,"onUpdate:modelValue":e=>f.value=e,activator:"parent",contentClass:"v-autocomplete__content",disabled:E.value,eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,transition:e.transition,onAfterEnter:W,onAfterLeave:U},e.menuProps),{default:()=>[a&&t.createVNode(Nr,t.mergeProps({ref:F,selected:T.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault(),onKeydown:z,onFocusin:Y,onFocusout:G,tabindex:"-1","aria-live":"polite",color:e.itemColor??e.color},$,e.listProps),{default:()=>[o["prepend-item"]?.(),!P.value.length&&!e.hideNoData&&(o["no-data"]?.()??t.createVNode(dr,{key:"no-data",title:n(e.noDataText)},null)),t.createVNode(Ai,{ref:v,renderless:!0,items:P.value},{default:a=>{let{item:l,index:n,itemRef:r}=a
...
return Mt((()=>t.createVNode("li",{"aria-hidden":"true",class:["v-breadcrumbs-divider",e.class],style:e.style},[l?.default?.()??e.divider]))),{}}}),as=ht({active:Boolean,activeClass:String,activeColor:String,color:String,disabled:Boolean,title:String,...yt(),...mo(),...Ba({tag:"li"})},"VBreadcrumbsItem"),ls=Pt()({name:"VBreadcrumbsItem",props:as(),setup(e,a){let{slots:l,attrs:o}=a
...
return null!=t?Math.round(100*t)/100:1},getColor:(e,t)=>({...e,a:Number(t)})}],to:tt,from:lt},Ts={inputProps:{type:"number",min:0},inputs:[{label:"H",max:360,step:1,getValue:e=>Math.round(e.h),getColor:(e,t)=>({...e,h:Number(t)})},{label:"S",max:1,step:.01,getValue:e=>Math.round(100*e.s)/100,getColor:(e,t)=>({...e,s:Number(t)})},{label:"L",max:1,step:.01,getValue:e=>Math.round(100*e.l)/100,getColor:(e,t)=>({...e,l:Number(t)})},{label:"A",max:1,step:.01,getValue:e=>{let{a:t}=e
return null!=t?Math.round(100*t)/100:1},getColor:(e,t)=>({...e,a:Number(t)})}],to:ot,from:nt},Ds={inputProps:{type:"text"},inputs:[{label:"HEXA",getValue:e=>e,getColor:(e,t)=>t}],to:dt,from:function(e){return lt(ct(e))}},Es={rgb:{...Rs,inputs:Rs.inputs?.slice(0,3)},rgba:Rs,hsl:{...Ts,inputs:Ts.inputs.slice(0,3)},hsla:Ts,hex:{...Ds,inputs:[{label:"HEX",getValue:e=>e.slice(0,7),getColor:(e,t)=>t}]},hexa:Ds},Fs=e=>{let{label:a,...l}=e
...
return Mt((()=>t.createVNode("div",{class:["v-color-picker-swatches",e.class],style:[{maxHeight:f(e.maxHeight)},e.style]},[t.createVNode("div",null,[e.swatches.map((a=>t.createVNode("div",{class:"v-color-picker-swatches__swatch"},[a.map((a=>{const o=et(a),n=lt(o),r=rt(o)
...
let t
try{t=lt(et(e))}catch(e){return Me(e),null}return t}),(t=>t?function(e,t){if(null==t||"string"==typeof t){const t=dt(e)
return 1===e.a?t.slice(0,7):t}if("object"==typeof t){let a
return w(t,["r","g","b"])?a=tt(e):w(t,["h","s","l"])?a=ot(e):w(t,["h","s","v"])&&(a=e),function(e,t){if(t){const{a:t,...a}=e
...
return t.onBeforeMount((()=>{e.modes.includes(a.value)||(a.value=e.modes[0])})),Ct({VSlider:{color:void 0,trackColor:void 0,trackFillColor:void 0}}),Mt((()=>{const l=eu.filterProps(e)
return t.createVNode(eu,t.mergeProps({rounded:e.rounded,elevation:e.elevation,theme:e.theme,class:["v-color-picker",r.value,e.class],style:[{"--v-color-picker-color-hsv":it({...n.value??As,a:1})},e.style]},l,{maxWidth:e.width}),{default:()=>[!e.hideCanvas&&t.createVNode(Bs,{key:"canvas",color:n.value,"onUpdate:color":s,disabled:e.disabled,dotSize:e.dotSize,width:e.width,height:e.canvasHeight},null),(!e.hideSliders||!e.hideInputs)&&t.createVNode("div",{key:"controls",class:"v-color-picker__controls"},[!e.hideSliders&&t.createVNode(Ks,{key:"preview",color:n.value,"onUpdate:color":s,hideAlpha:!a.value.endsWith("a"),disabled:e.disabled},null),!e.hideInputs&&t.createVNode($s,{key:"edit",modes:e.modes,mode:a.value,"onUpdate:mode":e=>a.value=e,color:n.value,"onUpdate:color":s,disabled:e.disabled},null)]),e.showSwatches&&t.createVNode(Qs,{key:"swatches",color:n.value,"onUpdate:color":s,maxHeight:e.swatchesMaxHeight,swatches:e.swatches,disabled:e.disabled},null)]})})),{}}})
...
const{t:r}=ya(),i=t.ref(),s=t.shallowRef(!1),u=t.shallowRef(!0),d=t.shallowRef(!1),v=t.ref(),p=t.ref(),f=sa(e,"menu"),m=t.computed({get:()=>f.value,set:e=>{f.value&&!e&&v.value?.ΨopenChildren.size||(f.value=e)}}),g=t.shallowRef(-1)
let h=!1
const y=t.computed((()=>i.value?.color)),b=t.computed((()=>m.value?e.closeText:e.openText)),{items:V,transformIn:w,transformOut:S}=wr(e),{textColorClasses:k,textColorStyles:x}=ul(y),N=sa(e,"modelValue",[],(e=>w(A(e))),(t=>{const a=S(t)
return e.multiple?a:a[0]??null})),C=cn(e),_=t.computed((()=>!(!e.chips&&!n.chip))),I=t.computed((()=>_.value||!!n.selection)),B=t.shallowRef(e.multiple||I.value?"":N.value[0]?.title??""),R=t.computed({get:()=>B.value,set:t=>{if(B.value=t??"",e.multiple||I.value||(N.value=[br(e,t)]),t&&e.multiple&&e.delimiters?.length){const a=t.split(new RegExp(`(?:${e.delimiters.join("|")})+`))
a.length>1&&(a.forEach((t=>{(t=t.trim())&&K(br(e,t))})),B.value="")}t||(g.value=-1),u.value=!t}}),T=t.computed((()=>"function"==typeof e.counterValue?e.counterValue(N.value):"number"==typeof e.counterValue?e.counterValue:e.multiple?N.value.length:R.value.length))
t.watch(B,(e=>{h?t.nextTick((()=>h=!1)):s.value&&!m.value&&(m.value=!0),o("update:search",e)})),t.watch(N,(t=>{e.multiple||I.value||(B.value=t[0]?.title??"")}))
const{filteredItems:D,getMatches:E}=Mi(e,V,(()=>u.value?"":R.value)),F=t.computed((()=>e.hideSelected?D.value.filter((e=>!N.value.some((t=>t.value===e.value)))):D.value)),$=t.computed((()=>N.value.map((e=>e.value)))),M=t.computed((()=>(!0===e.autoSelectFirst||"exact"===e.autoSelectFirst&&R.value===F.value[0]?.title)&&F.value.length>0&&!u.value&&!d.value)),O=t.computed((()=>e.hideNoData&&!F.value.length||C.isReadonly.value||C.isDisabled.value)),L=t.ref(),z=Ri(L,i)
function j(t){h=!0,e.openOnClear&&(m.value=!0)}function H(){O.value||(m.value=!0)}function W(e){O.value||(s.value&&(e.preventDefault(),e.stopPropagation()),m.value=!m.value)}function U(e){" "!==e.key&&oe(e)&&i.value?.focus()}function Y(t){if(function(e){return e.isComposing&&P.includes(e.key)}(t)||C.isReadonly.value)return
const a=i.value.selectionStart,l=N.value.length
if(["Enter","ArrowDown","ArrowUp"].includes(t.key)&&t.preventDefault(),["Enter","ArrowDown"].includes(t.key)&&(m.value=!0),["Escape"].includes(t.key)&&(m.value=!1),["Enter","Escape","Tab"].includes(t.key)&&(M.value&&["Enter","Tab"].includes(t.key)&&!N.value.some((e=>{let{value:t}=e
return t===F.value[0].value}))&&K(D.value[0]),u.value=!0),"ArrowDown"===t.key&&M.value&&L.value?.focus("next"),"Enter"===t.key&&R.value&&(K(br(e,R.value)),I.value&&(B.value="")),["Backspace","Delete"].includes(t.key)){if(!e.multiple&&I.value&&N.value.length>0&&!R.value)return K(N.value[0],!1)
if(~g.value){t.preventDefault()
const e=g.value
K(N.value[g.value],!1),g.value=e>=l-1?l-2:e}else"Backspace"!==t.key||R.value||(g.value=l-1)}else if(e.multiple)if("ArrowLeft"===t.key){if(g.value<0&&a>0)return
const e=g.value>-1?g.value-1:l-1
N.value[e]?g.value=e:(g.value=-1,i.value.setSelectionRange(R.value.length,R.value.length))}else if("ArrowRight"===t.key){if(g.value<0)return
const e=g.value+1
N.value[e]?g.value=e:(g.value=-1,i.value.setSelectionRange(0,0))}else~g.value&&oe(t)&&(g.value=-1)}function G(){e.eager&&p.value?.calculateVisibleItems()}function q(){s.value&&(u.value=!0,i.value?.focus())}function K(a){let l=!(arguments.length>1&&void 0!==arguments[1])||arguments[1]
if(a&&!a.props.disabled)if(e.multiple){const t=N.value.findIndex((t=>(e.valueComparator||c)(t.value,a.value))),o=null==l?!~t:l
if(~t){const e=o?[...N.value,a]:[...N.value]
e.splice(t,1),N.value=e}else o&&(N.value=[...N.value,a])
e.clearOnSelect&&(R.value="")}else{const e=!1!==l
N.value=e?[a]:[],B.value=e&&!I.value?a.title:"",t.nextTick((()=>{m.value=!1,u.value=!0}))}}function X(e){s.value=!0,setTimeout((()=>{d.value=!0}))}function Z(e){d.value=!1}function Q(t){null!=t&&(""!==t||e.multiple||I.value)||(N.value=[])}return t.watch(s,((t,a)=>{if(!t&&t!==a&&(g.value=-1,m.value=!1,R.value)){if(e.multiple)return void K(br(e,R.value))
if(!I.value)return
N.value.some((e=>{let{title:t}=e
return t===R.value}))?B.value="":K(br(e,R.value))}})),t.watch(m,(()=>{if(!e.hideSelected&&m.value&&N.value.length){const t=F.value.findIndex((t=>N.value.some((a=>(e.valueComparator||c)(a.value,t.value)))))
a&&window.requestAnimationFrame((()=>{t>=0&&p.value?.scrollToIndex(t)}))}})),t.watch((()=>e.items),((e,t)=>{m.value||s.value&&!t.length&&e.length&&(m.value=!0)})),Mt((()=>{const a=!!(!e.hideNoData||F.value.length||n["prepend-item"]||n["append-item"]||n["no-data"]),l=N.value.length>0,o=Ni.filterProps(e)
return t.createVNode(Ni,t.mergeProps({ref:i},o,{modelValue:R.value,"onUpdate:modelValue":[e=>R.value=e,Q],focused:s.value,"onUpdate:focused":e=>s.value=e,validationValue:N.externalValue,counterValue:T.value,dirty:l,class:["v-combobox",{"v-combobox--active-menu":m.value,"v-combobox--chips":!!e.chips,"v-combobox--selection-slot":!!I.value,"v-combobox--selecting-index":g.value>-1,["v-combobox--"+(e.multiple?"multiple":"single")]:!0},e.class],style:e.style,readonly:C.isReadonly.value,placeholder:l?void 0:e.placeholder,"onClick:clear":j,"onMousedown:control":H,onKeydown:Y}),{...n,default:()=>t.createVNode(t.Fragment,null,[t.createVNode(fi,t.mergeProps({ref:v,modelValue:m.value,"onUpdate:modelValue":e=>m.value=e,activator:"parent",contentClass:"v-combobox__content",disabled:O.value,eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,transition:e.transition,onAfterEnter:G,onAfterLeave:q},e.menuProps),{default:()=>[a&&t.createVNode(Nr,t.mergeProps({ref:L,selected:$.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault(),onKeydown:U,onFocusin:X,onFocusout:Z,tabindex:"-1","aria-live":"polite",color:e.itemColor??e.color},z,e.listProps),{default:()=>[n["prepend-item"]?.(),!F.value.length&&!e.hideNoData&&(n["no-data"]?.()??t.createVNode(dr,{key:"no-data",title:r(e.noDataText)},null)),t.createVNode(Ai,{ref:p,renderless:!0,items:F.value},{default:a=>{let{item:l,index:o,itemRef:r}=a
const i=t.mergeProps(l.props,{ref:r,key:l.value,active:!(!M.value||0!==o)||void 0,onClick:()=>K(l,null)})
...
if(Array.isArray(a))throw new Error("Multiple matches is not implemented")
return"number"==typeof a&&~a?t.createVNode(t.Fragment,null,[t.createVNode("span",{class:"v-combobox__unmask"},[e.substr(0,a)]),t.createVNode("span",{class:"v-combobox__mask"},[e.substr(a,l)]),t.createVNode("span",{class:"v-combobox__unmask"},[e.substr(a+l)])]):e}(l.title,E(l)?.title,R.value?.length??0)})}}),n["append-item"]?.()]})]}),N.value.map(((a,l)=>{function o(e){e.stopPropagation(),e.preventDefault(),K(a,!1)}const r={"onClick:close":o,onKeydown(e){"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),e.stopPropagation(),o(e))},onMousedown(e){e.preventDefault(),e.stopPropagation()},modelValue:!0,"onUpdate:modelValue":void 0},i=_.value?!!n.chip:!!n.selection,s=i?ae(_.value?n.chip({item:a,index:l,props:r}):n.selection({item:a,index:l})):void 0
if(!i||s)return t.createVNode("div",{key:a.value,class:["v-combobox__selection",l===g.value&&["v-combobox__selection--selected",k.value]],style:l===g.value?x.value:{}},[_.value?n.chip?t.createVNode(ll,{key:"chip-defaults",defaults:{VChip:{closable:e.closableChips,size:"small",text:a.title}}},{default:()=>[s]}):t.createVNode(jn,t.mergeProps({key:"chip",closable:e.closableChips,size:"small",text:a.title,disabled:a.props.disabled},r),null):s??t.createVNode("span",{class:"v-combobox__selection-text"},[a.title,e.multiple&&l<N.value.length-1&&t.createVNode("span",{class:"v-combobox__selection-comma"},[t.createTextVNode(",")])])])}))]),"append-inner":function(){for(var a=arguments.length,l=new Array(a),o=0;o<a;o++)l[o]=arguments[o]
return t.createVNode(t.Fragment,null,[n["append-inner"]?.(...l),e.hideNoData&&!e.items.length||!e.menuIcon?void 0:t.createVNode(Zl,{class:"v-combobox__menu-icon",icon:e.menuIcon,onMousedown:W,onClick:ee,"aria-label":r(b.value),title:r(b.value),tabindex:"-1"},null)])}})})),vi({isFocused:s,isPristine:u,menu:m,search:R,selectionIndex:g,filteredItems:D,select:K},i)}}),ou={"001":1,AD:1,AE:6,AF:6,AG:0,AI:1,AL:1,AM:1,AN:1,AR:1,AS:0,AT:1,AU:1,AX:1,AZ:1,BA:1,BD:0,BE:1,BG:1,BH:6,BM:1,BN:1,BR:0,BS:0,BT:0,BW:0,BY:1,BZ:0,CA:0,CH:1,CL:1,CM:1,CN:1,CO:0,CR:1,CY:1,CZ:1,DE:1,DJ:6,DK:1,DM:0,DO:0,DZ:6,EC:1,EE:1,EG:6,ES:1,ET:0,FI:1,FJ:1,FO:1,FR:1,GB:1,"GB-alt-variant":0,GE:1,GF:1,GP:1,GR:1,GT:0,GU:0,HK:0,HN:0,HR:1,HU:1,ID:0,IE:1,IL:0,IN:0,IQ:6,IR:6,IS:1,IT:1,JM:0,JO:6,JP:0,KE:0,KG:1,KH:0,KR:0,KW:6,KZ:1,LA:0,LB:1,LI:1,LK:1,LT:1,LU:1,LV:1,LY:6,MC:1,MD:1,ME:1,MH:0,MK:1,MM:0,MN:1,MO:0,MQ:1,MT:0,MV:5,MX:0,MY:1,MZ:0,NI:0,NL:1,NO:1,NP:0,NZ:1,OM:6,PA:0,PE:0,PH:0,PK:0,PL:1,PR:0,PT:0,PY:0,QA:6,RE:1,RO:1,RS:1,RU:1,SA:0,SD:6,SE:1,SG:0,SI:1,SK:1,SM:1,SV:0,SY:6,TH:0,TJ:1,TM:1,TR:1,TT:0,TW:0,UA:1,UM:0,US:0,UY:1,UZ:1,VA:1,VE:0,VI:0,VN:1,WS:0,XK:1,YE:0,ZA:0,ZW:0}
...
function u(){n.value=r.value,l("save",r.value)}function d(){r.value=structuredClone(t.toRaw(n.value)),l("cancel")}function v(a){return t.createVNode(t.Fragment,null,[t.createVNode(Fo,t.mergeProps({disabled:s.value,variant:"text",color:e.color,onClick:d,text:i(e.cancelText)},a),null),t.createVNode(Fo,t.mergeProps({disabled:s.value,variant:"text",color:e.color,onClick:u,text:i(e.okText)},a),null)])}let p=!1
return Mt((()=>t.createVNode(t.Fragment,null,[o.default?.({model:r,save:u,cancel:d,isPristine:s.value,get actions(){return p=!0,v}}),!p&&v()]))),{save:u,cancel:d,isPristine:s}}}),wu=ht({expandOnClick:Boolean,showExpand:Boolean,expanded:{type:Array,default:()=>[]}},"DataTable-expand"),Su=Symbol.for("vuetify:datatable:expanded")
...
else t?isNaN(+e.width)&&Oe(`Multiple fixed columns should have a static width (key: ${e.key})`):e.lastFixed=!0,t=!0
...
return e}const Sc=ht({color:String,disableSort:Boolean,fixedHeader:Boolean,multiSort:Boolean,sortAscIcon:{type:Ot,default:"$sortAsc"},sortDescIcon:{type:Ot,default:"$sortDesc"},headerProps:{type:Object},sticky:Boolean,...xn(),...ro()},"VDataTableHeaders"),kc=Pt()({name:"VDataTableHeaders",props:Sc(),setup(e,a){let{slots:l}=a
...
const l=a.date(t)
return!(!e.min||!a.isAfter(a.date(e.min),l))||(!(!e.max||!a.isAfter(l,a.date(e.max)))||(Array.isArray(e.allowedDates)&&e.allowedDates.length>0?!e.allowedDates.some((e=>a.isSameDay(a.date(e),l))):"function"==typeof e.allowedDates&&!e.allowedDates(l)))}return{displayValue:o,daysInMonth:v,daysInWeek:d,genDays:c,model:l,weeksInMonth:u,weekDays:s,weekNumbers:p}}const Sd=ht({color:String,hideWeekdays:Boolean,multiple:[Boolean,Number,String],showWeek:Boolean,transition:{type:String,default:"picker-transition"},reverseTransition:{type:String,default:"picker-reverse-transition"},...x(Vd(),["displayValue"])},"VDatePickerMonth"),kd=Pt()({name:"VDatePickerMonth",props:Sd(),emits:{"update:modelValue":e=>!0,"update:month":e=>!0,"update:year":e=>!0},setup(e,a){let{emit:l,slots:o}=a
...
return t.withDirectives(t.createVNode("button",{class:["v-stepper-item",{"v-stepper-item--complete":c.value,"v-stepper-item--disabled":e.disabled,"v-stepper-item--error":u.value},o?.selectedClass.value],disabled:!e.editable,type:"button",onClick:function(){o?.toggle()}},[i.value&&Dl(!0,"v-stepper-item"),t.createVNode(Uo,{key:"stepper-avatar",class:"v-stepper-item__avatar",color:a?e.color:void 0,size:24},{default:()=>[l.icon?.(v.value)??(d.value?t.createVNode(Zl,{icon:d.value},null):n.value)]}),t.createVNode("div",{class:"v-stepper-item__content"},[r&&t.createVNode("div",{key:"title",class:"v-stepper-item__title"},[l.title?.(v.value)??e.title]),p&&t.createVNode("div",{key:"subtitle",class:"v-stepper-item__subtitle"},[l.subtitle?.(v.value)??e.subtitle]),l.default?.(v.value)])]),[[t.resolveDirective("ripple"),e.ripple&&e.editable,null]])})),{}}}),hp=ht({...x(ws(),["continuous","nextIcon","prevIcon","showArrows","touch","mandatory"])},"VStepperWindow"),yp=Pt()({name:"VStepperWindow",props:hp(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
ye(t,{backgroundColor:[a,"currentcolor"],transform:[`translate${r}(${v}px) scale${r}(${l[d]/o[d]||0})`,`translate${r}(${v/m}px) scale${r}(${(f-1)/m+1})`,"none"],transformOrigin:Array(3).fill(p)},{duration:225,easing:Rt})}}return Mt((()=>{const a=Fo.filterProps(e)
...
if(a&&e in a)return a[e]}sf.version="3.7.12"
const cf=function(){return sf({components:Qp,directives:rf,...arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}})},df="3.7.12"
